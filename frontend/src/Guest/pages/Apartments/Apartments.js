    ...
    render() {
        ...
        return (
            <>
                ...
                <SolutionView/>
                <section id="medical-travel" className="container-fluid blue-background">
                ...
                <section id="corporate-housing" className="container-fluid">
                    <div className="row container">
                        <div className="col-md">
                ...
                <section id="stars-experience" className="container-fluid text-center stars-background">
                ...
                <section id="stay-boston" className="container-fluid grey-background">
                ...
                <section id="explore-locations" className="container-fluid">
                ...
                <section id="look-rentals" className="container-fluid grey-background">
                    <div className="row container">
                        <div className="col-sm">
